...
{
    //update order: weights3 ->batch_norm2 -> weights2 -> batch_norm1 -> weights1

    update_weights_3(predictions, correct_output);

    
}

void DenseNetwork::update_weights_3(arma::mat predictions, arma::mat correct_output)
{
